...
FAQ = [
    ("児童手当計算ツールは無料で使えますか？", "はい、完全無料・登録不要でご利用いただけます。"),
    ("2024年10月の改正でどう変わりましたか？", "①所得制限が完全撤廃 ②支給対象が高校生（18歳年度末）まで延長 ③第3子以降が月30,000円に増額 ④支払い回数が年6回に増加しました。"),
    ("第1子・第2子・第3子の数え方は？", "基本的に現在養育している子どもの数で数えます。大学生など別居の子も要件を満たせばカウントされる場合があります。詳しくはお住まいの市区町村にご確認ください。"),
    ("計算結果はいつから受け取れますか？", "出生届・転入届後に申請が必要です。申請翌月分から支給されます。出生後15日以内に申請すると生まれた月分も受給できます。"),
    ("所得制限はなくなりましたか？", "はい、2024年10月の改正で所得制限・所得上限制限がともに撤廃されました。どの所得でも同額受給できます。"),
]

HOW_TO = [
    "子ども1人目の年齢区分をセレクトボックスで選択する",
    "2人目・3人目がいる場合は同様に年齢区分を選択する",
    "4人目以降がいる場合は人数を選択する",
    "「計算する」ボタンをクリックする",
    "月額・年額の合計と内訳を確認する（実際は市区町村で要申請）",
]
